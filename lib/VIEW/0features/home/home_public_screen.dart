    ...
    return SafeArea(
      child: Scaffold(
          ...
          bottomNavigationBar: CurvedNavigationBar(
            ...
            index: _page,
            height: GlobalResponsive.bigDiference(context) + 28,
            items: [
              Icon(Icons.search_rounded, color: Colors.white, size: GlobalResponsive.bigDiference(context)),
              Icon(Icons.favorite_rounded, color: Colors.white, size: GlobalResponsive.bigDiference(context)),
              Icon(Icons.add_reaction_sharp, color: Colors.white, size: GlobalResponsive.bigDiference(context)),
              Icon(Icons.notifications_active, color: Colors.white, size: GlobalResponsive.bigDiference(context)),
              Icon(Icons.supervised_user_circle, color: Colors.white, size: GlobalResponsive.bigDiference(context)),
            ],
